...
func main() {
	...
	for {
		...
		textWidth, _ := tinyfont.LineWidth(font, string(msg))
		tinyfont.WriteLine(watch, font, width/2-int16(textWidth/2), height/2+fontHeight/2, string(msg), color.RGBA{255, 255, 255, 255})
